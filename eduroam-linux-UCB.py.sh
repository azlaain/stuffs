...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "University College Birmingham"
Config.profilename = ""
Config.url = " \
    ""http://www.ucb.ac.uk/about-us/eduroam-at-university-college-birmingham.aspx"
Config.email = "itsu@ucb.ac.uk"
Config.title = "eduroam CAT"
Config.server_match = "ucb.ac.uk"
...
Config.user_realm = "ucb.ac.uk"
Config.ssids = ['eduroam']
Config.del_ssids = ['Cambrian_Hall', 'RHStudent', 'SRStudent', 'The_Maltings', 'UCB', 'UCB-Guest', 'UCB-WiFi']
Config.servers = ['DNS:oprs.ucb.ac.uk', 'DNS:oprs1.ucb.ac.uk', 'DNS:oprs2.ucb.ac.uk', 'DNS:ucb.ac.uk']
